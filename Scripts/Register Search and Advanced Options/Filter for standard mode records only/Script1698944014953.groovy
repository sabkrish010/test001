...
WebUI.selectOptionByValue(findTestObject('Register Search and Advanced Options/Filter/Add Filters/select_FilterField'), 
    'Hide Investigation Records', false)

WebUI.delay(2)

'Press Go'
WebUI.click(findTestObject('Register Search and Advanced Options/Filter/Add Filters/input_go'), FailureHandling.OPTIONAL)

'Press Go'
WebUI.click(findTestObject('Register Search and Advanced Options/Filter/Add Filters/input_Delete_goBottom'), FailureHandling.OPTIONAL)
