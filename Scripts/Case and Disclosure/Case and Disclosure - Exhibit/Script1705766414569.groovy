...
WebUI.click(findTestObject('Case and Disclosure/Exhibit/a_Add Exhibit'))

WebUI.callTestCase(findTestCase('Case and Disclosure/Exhibit List/Adding Exhibits'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Case and Disclosure/Exhibit List/Generate Exhibit List'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Case and Disclosure/Exhibit List/Exhibit List Display'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Case and Disclosure/Exhibit List/Generate Submit - Continuation'), [:], FailureHandling.OPTIONAL)
