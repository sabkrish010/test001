...
WebUI.selectOptionByValue(findTestObject('Case and Disclosure/Exhibit/select_Type'), 'Drugs', false)
...
WebUI.setText(findTestObject('Case and Disclosure/Exhibit/input_Title_Title'), ('Class A drugs found -' + formattedDate) + 
    dateHour)

WebUI.setText(findTestObject('Case and Disclosure/Exhibit/Input_Description'), ('Amount of drugs found at seen -' + formattedDate) + 
    dateHour)
