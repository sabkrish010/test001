...
'Add new record for Outcome Register'
...
WebUI.callTestCase(findTestCase('Core Functionality/Registers/Outcome/Add Outcome Record(Redact)'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Core Functionality/Tools/Task/Add Task (User Redact) - Outcome'), [:], FailureHandling.STOP_ON_FAILURE)
