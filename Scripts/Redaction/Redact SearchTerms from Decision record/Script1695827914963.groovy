...
WebUI.callTestCase(findTestCase('Core Functionality/Registers/Decision/Add Decision record for redaction'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.scrollToElement(findTestObject('Redaction/DecisionSearchResult(Results Pop-Up)'), 2)
...
WebUI.setText(findTestObject('General/Quick Search/input_QuickSearch'), 'sholape')
...
WebUI.verifyElementNotPresent(findTestObject('Core Functionality/Research/Global Search/Label_decision'), 2)
...
WebUI.click(findTestObject('General/Links/a_Add Decision'))
