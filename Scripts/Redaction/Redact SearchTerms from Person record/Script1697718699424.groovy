...
WebUI.callTestCase(findTestCase('Core Functionality/Registers/Person/Add Person record for redaction'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Register Search and Advanced Options/Enter Register Search Term/input_searchTerm'), 'Foxtrot')
...
WebUI.setText(findTestObject('General/Quick Search/input_QuickSearch'), 'Foxtrot')
...
WebUI.setText(findTestObject('Core Functionality/Research/Global Search/input_searchTerm(GlobalSearch)'), 'Foxtrot')
