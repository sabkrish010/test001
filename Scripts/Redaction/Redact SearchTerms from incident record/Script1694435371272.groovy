...
WebUI.setText(findTestObject('Core Functionality/Registers/Task/Add New Task record/textarea_Notes'), 'The successive west vanishes inside the bog. Can the rear sound the Mattheus owner? An elite opera progresses. The immortal disconnects an erroneous surgery without any variant. Stewart drives Porsche.')
...
WebUI.waitForElementClickable(findTestObject('Redaction/Close(Redaction Results Pop-Up)'), 3)
...
WebUI.scrollToElement(findTestObject('Redaction/IncidentSearchResult(Results Pop-Up)'), 2)
