...
WebUI.callTestCase(findTestCase('Core Functionality/Registers/Organisation/Add Organisation for redact'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.scrollToElement(findTestObject('Redaction/OrganisationRedact(Results Pop-Up)'), 2, FailureHandling.OPTIONAL)
...
WebUI.click(findTestObject('General/Links/a_Add Organisation'))
