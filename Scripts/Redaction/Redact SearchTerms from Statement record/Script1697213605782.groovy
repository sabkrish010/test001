...
WebUI.callTestCase(findTestCase('Core Functionality/Registers/Statement/Add Statement for redaction'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Core Functionality/Registers/Task/Add New Task record/textarea_Notes'), 'The successive west vanishes inside the bog. Can the rear sound the Matt owner? An elite opera progresses. The immortal disconnects an erroneous surgery without any variant. Stewart drives Porsche.')
...
WebUI.setText(findTestObject('Core Functionality/Registers/Task/Edit Task Record/input_Title(Task)'), 'Matt slang recovers the Rogers repeated performance in a cough')
...
WebUI.scrollToElement(findTestObject('Redaction/PersonRedact(Results Pop-Up)'), 2, FailureHandling.OPTIONAL)

WebUI.enhancedClick(findTestObject('Redaction/RedactBtn(Result2)'))
...
WebUI.verifyElementNotPresent(findTestObject('General/Quick Search/QuickSearch(Results)'), 2, FailureHandling.OPTIONAL)
...
WebUI.verifyElementNotPresent(findTestObject('Core Functionality/Research/Global Search/Label_statement(GS)'), 0)
...
WebUI.click(findTestObject('General/Links/a_Add Statement'))

WebUI.setText(findTestObject('General/Pop-Up/input_Search All Fields(Pop-Up)'), 'Strackley')

WebUI.click(findTestObject('General/Pop-Up/GoBtn(Select Pop-Up)'))

WebUI.verifyElementPresent(findTestObject('General/Pop-Up/Page_Clue - Edit Address/Pop-Up Search (0 results)'), 0)
...
WebUI.setText(findTestObject('Register Search and Advanced Options/Enter Register Search Term/input_searchTerm'), 'Matt slang recovers the Rogers repeated performance in a cough')
...
WebUI.setText(findTestObject('Register Search and Advanced Options/Enter Register Search Term/input_searchTerm'), '12, Crest Hill')
...
WebUI.setText(findTestObject('Register Search and Advanced Options/Enter Register Search Term/input_searchTerm'), 'Ratburn')
...
WebUI.setText(findTestObject('Register Search and Advanced Options/Enter Register Search Term/input_searchTerm'), 'Stewartz')
