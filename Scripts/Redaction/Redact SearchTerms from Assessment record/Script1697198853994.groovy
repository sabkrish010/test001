...
WebUI.callTestCase(findTestCase('Core Functionality/Registers/Assessment/Add Assessment record for redaction'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementPresent(findTestObject('Redaction/Subject_FieldLabel'), 3)
...
WebUI.scrollToElement(findTestObject('Redaction/AssessmentSearchResult(Results Pop-Up)'), 2)
...
WebUI.verifyElementNotPresent(findTestObject('Core Functionality/Research/Global Search/Label_Assessment(GS)'), 10)
