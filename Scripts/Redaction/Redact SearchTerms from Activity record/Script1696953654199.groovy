...
WebUI.callTestCase(findTestCase('Core Functionality/Tools/Activity/Add Activity for redaction'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.scrollToElement(findTestObject('Redaction/Redaction_Result3'), 2)

WebUI.click(findTestObject('Redaction/RedactBtn(Result 3)'))

WebUI.click(findTestObject('Redaction/RedactConfirm_Result3'))
...
WebUI.verifyElementNotPresent(findTestObject('Core Functionality/Research/Global Search/Label_Activity(GS)'), 2, FailureHandling.OPTIONAL)

WebUI.callTestCase(findTestCase('General/Switch to Investigation Mode'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.delay(2)

WebUI.callTestCase(findTestCase('Core Functionality/Tools/Activity/Navigate to Activity'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Core Functionality/Registers/Activity/a_Add Activity(Inv Mode)'))
