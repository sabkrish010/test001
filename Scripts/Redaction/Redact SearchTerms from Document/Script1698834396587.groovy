...
WebUI.setText(findTestObject('Core Functionality/Registers/Person/Person pop-up/Subject Popup/input_Surname_Subject'), 'Haraldson')

WebUI.setText(findTestObject('Core Functionality/Registers/Person/Person pop-up/Person Pop-Up fields/textarea_Notes'), 'always Haraldson')
...
WebUI.enhancedClick(findTestObject('Core Functionality/Integrations/HR Integration(Amazon)/Add Person Pop-up/input_personSave'))
...
WebUI.click(findTestObject('Core Functionality/Registers/Person/td_Perosn Name'))

WebUI.click(findTestObject('Core Functionality/Registers/Person/Edit Person/input_edit'))

WebUI.callTestCase(findTestCase('Core Functionality/Tools/File/Add Document record for redaction'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Redaction/a_RedactionSearchResults'))

WebUI.scrollToElement(findTestObject('Redaction/AddressSearchResult(Results Pop-Up)'), 2)
...
not_run: WebUI.selectOptionByValue(findTestObject('Core Functionality/Registers/Task/Add New Task record/select_Status'), 
    'Complete', false)

not_run: WebUI.callTestCase(findTestCase('General/Save the record'), [:], FailureHandling.STOP_ON_FAILURE)

not_run: WebUI.callTestCase(findTestCase('Core Functionality/Registers/Person/Navigate to Person Register'), [:], FailureHandling.STOP_ON_FAILURE)
...
not_run: WebUI.setText(findTestObject('Register Search and Advanced Options/Enter Register Search Term/input_searchTerm'), 
    'Rowan Haraldson')

not_run: WebUI.click(findTestObject('General/Run General Search (Press Go Button)/input_go'))

not_run: WebUI.callTestCase(findTestCase('General/Select a record from view'), [:], FailureHandling.OPTIONAL)

not_run: WebUI.callTestCase(findTestCase('General/Delete Record'), [:], FailureHandling.STOP_ON_FAILURE)

not_run: WebUI.setText(findTestObject('General/Quick Search/input_QuickSearch'), 'Rowan Haraldson')

not_run: WebUI.verifyElementNotPresent(findTestObject('General/Quick Search/QuickSearch(Results)'), 2)

not_run: WebUI.callTestCase(findTestCase('Core Functionality/Research/Global Search/Navigate to Global Search'), [:], FailureHandling.STOP_ON_FAILURE)

not_run: WebUI.setText(findTestObject('Core Functionality/Research/Global Search/input_searchTerm(GlobalSearch)'), 'Rowan Haraldson')

not_run: WebUI.click(findTestObject('Core Functionality/Research/Global Search/button_Go'), FailureHandling.STOP_ON_FAILURE)

//uncomment after Rich's ES fix
not_run: WebUI.verifyElementNotPresent(findTestObject('Core Functionality/Research/Global Search/span_No results found(GS)'), 
    2, FailureHandling.OPTIONAL)

not_run: WebUI.verifyElementNotPresent(findTestObject('Core Functionality/Research/Global Search/Label_decision'), 0)
...
not_run: WebUI.verifyElementPresent(findTestObject('Register Search and Advanced Options/regsiterSearch(0 hits for search)'), 
    2)
...
not_run: WebUI.click(findTestObject('General/Links/a_Add Material'))

not_run: WebUI.setText(findTestObject('General/Pop-Up/input_Search All Fields(Pop-Up)'), 'Rowan Haraldson')

not_run: WebUI.click(findTestObject('General/Pop-Up/GoBtn(Select Pop-Up)'))

not_run: WebUI.verifyElementPresent(findTestObject('General/Pop-Up/Page_Clue - Edit Address/Pop-Up Search (0 results)'), 
    0)

not_run: WebUI.click(findTestObject('General/Pop-Up/Add Pop-Up_Close'))

not_run: WebUI.callTestCase(findTestCase('General/Save the record'), [:], FailureHandling.STOP_ON_FAILURE)

not_run: WebUI.callTestCase(findTestCase('General/Delete Record'), [:], FailureHandling.STOP_ON_FAILURE)

not_run: WebUI.click(findTestObject('Core Functionality/Registers/Task/Navigate to Task Register/a_Tools'))

not_run: WebUI.click(findTestObject('Core Functionality/Registers/Task/Navigate to Task Register/a_Task'))
...
not_run: WebUI.setText(findTestObject('Register Search and Advanced Options/Enter Register Search Term/input_searchTerm'), 
    'Jim slang recovers the Mark\'s repeated performance in a cough')
