...
String NewFullname = NewUser + ' ' + GlobalVariable.NewFirstName
...
WebUI.dragAndDropToObject(findTestObject('Core Functionality/Options/User Management/User Teams/span_Username', [('Username') : NewUserSpan]), 
    findTestObject('Core Functionality/Options/User Management/User Teams/h3_Redact'))

WebUI.click(findTestObject('Core Functionality/Options/User Management/User Teams/h3_Redact'))
