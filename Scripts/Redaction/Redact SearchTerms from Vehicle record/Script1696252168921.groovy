...
WebUI.callTestCase(findTestCase('Core Functionality/Registers/Vehicle/Add Vehicle record for redaction'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.scrollToElement(findTestObject('Redaction/VehicleRedact(Results pop-Up)'), 2)
...
WebUI.setText(findTestObject('Core Functionality/Research/Global Search/input_searchTerm(GlobalSearch)'), 'Mattheus')
...
WebUI.verifyElementNotPresent(findTestObject('Core Functionality/Research/Global Search/Label_Vehicle'), 0)
...
WebUI.setText(findTestObject('Register Search and Advanced Options/Enter Register Search Term/input_searchTerm'), 'Mattheus')
...
WebUI.click(findTestObject('General/Links/a_Add Vehicle'))
