...
WebUI.callTestCase(findTestCase('Core Functionality/Registers/Address/Add Address record for redaction'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('General/Quick Search/input_QuickSearch'), 'strackley', FailureHandling.OPTIONAL)
...
WebUI.setText(findTestObject('Register Search and Advanced Options/Enter Register Search Term/input_searchTerm'), 'TF2 0BJ')
...
WebUI.verifyElementPresent(findTestObject('General/Pop-Up/Page_Clue - Edit Address/Pop-Up Search (0 results)'), 10)

WebUI.callTestCase(findTestCase('General/Delete Record'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('General/Quick Search'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.refresh()

WebUI.verifyElementPresent(findTestObject('Core Functionality/Research/Global Search/span_No results found(GS)'), 10, FailureHandling.OPTIONAL)
