...
WebUI.callTestCase(findTestCase('Core Functionality/Registers/Material/Add material for redaction'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Core Functionality/Registers/Task/Add New Task record/textarea_Notes'), 'The successive west vanishes inside the bog. Can the rear sound the John owner? An elite opera progresses. The immortal disconnects an erroneous surgery without any variant. Rowan drives Porsche.')
...
WebUI.setText(findTestObject('Core Functionality/Registers/Person/Person pop-up/Subject Popup/input_Surname_Subject'), 'Heraldsun', 
    FailureHandling.OPTIONAL)

WebUI.setText(findTestObject('Core Functionality/Registers/Person/Person pop-up/Subject Popup/input_Surname(RedactSubject)'), 
    'Heraldsun', FailureHandling.OPTIONAL)

WebUI.setText(findTestObject('Core Functionality/Registers/Person/Person pop-up/Person Pop-Up fields/textarea_Notes'), 'monstrous')
...
WebUI.waitForElementClickable(findTestObject('Redaction/Close(Redaction Results Pop-Up)'), 5)
...
WebUI.scrollToElement(findTestObject('Redaction/MaterialSearchResult(Results Pop-Up)'), 2)
...
WebUI.setText(findTestObject('Register Search and Advanced Options/Enter Register Search Term/input_searchTerm'), 'Rowen Heraldsun')
...
WebUI.setText(findTestObject('General/Quick Search/input_QuickSearch'), 'Rowen Heraldsun')
...
WebUI.setText(findTestObject('Core Functionality/Research/Global Search/input_searchTerm(GlobalSearch)'), 'Rowen Heraldsun')
...
WebUI.verifyElementNotPresent(findTestObject('Core Functionality/Research/Global Search/Label_decision'), 0)
...
WebUI.click(findTestObject('General/Links/a_Add Material'))

WebUI.setText(findTestObject('General/Pop-Up/input_Search All Fields(Pop-Up)'), 'Rowen Heraldsun')
