...
WebUI.callTestCase(findTestCase('Core Functionality/Registers/Communication/Add Communication for redaction'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.selectOptionByIndex(findTestObject('Core Functionality/Registers/Task/Add New Task record/select_AllocatedTo1'), 3, 
...
WebUI.click(findTestObject('Core Functionality/Registers/Task/Add New Task record/select_AllocatedTo'), FailureHandling.OPTIONAL)
...
WebUI.scrollToElement(findTestObject('Redaction/CommunicationRedact(Results Pop-Up)'), 2, FailureHandling.OPTIONAL)

WebUI.click(findTestObject('Redaction/RedactBtn(Result2)'))

WebUI.click(findTestObject('Redaction/RedactConfirm_Result2'))

WebUI.verifyElementPresent(findTestObject('Redaction/div_Redaction successful'), 5)
...
WebUI.verifyElementNotPresent(findTestObject('Core Functionality/Research/Global Search/Label_communication(GS)'), 0)
...
WebUI.setText(findTestObject('Register Search and Advanced Options/Enter Register Search Term/input_searchTerm'), 'Strackleys')
