...
'Add new record for Intelligence Register'
...
WebUI.callTestCase(findTestCase('Core Functionality/Registers/Intelligence/Select Add Intelligence (Standard Mode)'), [:], 
    FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Core Functionality/Registers/Intelligence/Add Intelligence Record(Redact)'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Core Functionality/Tools/Task/Add Task (User Redact) - Intelligence'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Core Functionality/Research/Global Search/input_searchTerm(GlobalSearch)'), (GlobalVariable.NewUser + 
