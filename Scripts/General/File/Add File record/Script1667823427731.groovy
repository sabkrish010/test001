...
WebUI.uploadFileWithDragAndDrop(findTestObject('Core Functionality/Registers/File/a_Browse button'), RunConfiguration.getProjectDir() + 
    '/TestFiles/DanilLysov.jpeg')

WebUI.selectOptionByIndex(findTestObject('Core Functionality/Registers/File/select_FileType'), 1, FailureHandling.STOP_ON_FAILURE)
...
WebUI.sendKeys(findTestObject('Core Functionality/Registers/File/input_FileReason'), Keys.chord(Keys.ARROW_DOWN, Keys.ENTER))

WebUI.enhancedClick(findTestObject('Core Functionality/Registers/File/input(AddFilePop-Up)'))
