...
WebUI.verifyElementClickable(findTestObject('Core Functionality/Research/Global Search/span_attachment'))

'Un-check the Records checkbox'
WebUI.click(findTestObject('Core Functionality/Research/Global Search/span_attachment'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.selectOptionByLabel(findTestObject('Core Functionality/Research/Global Search/select_SearchDropdown'), 'incident', 
    true)
