...
not_run: WebElement selectColumn = driver.findElement(By.xpath('//*[(text() = \'Address Line 1\' or . = \'Address Line 1\')]'))

not_run: selectColumn.click()

WebUI.click(findTestObject('Core Functionality/Options/Lists/Page_Clue - Lists/option_Address Line 1'))

WebUI.click(findTestObject('Core Functionality/Options/Lists/MoveRight(Lists)'))

WebUI.click(findTestObject('Core Functionality/Options/Lists/Page_Clue - Lists/option_Address Line 2'))

WebUI.click(findTestObject('Core Functionality/Options/Lists/MoveRight(Lists)'))

WebUI.enhancedClick(findTestObject('Core Functionality/Options/Lists/Save(Lists)'))
