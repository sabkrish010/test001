...
WebUI.verifyElementPresent(findTestObject('General/Switch Mode/span_(InvMode) _inInvstDash'), 2)

WebUI.verifyElementClickable(findTestObject('General/Switch Mode/a_Switch to Standard Mode'))
