...
WebUI.uncheck(findTestObject('Register Search and Advanced Options/View/Show on Dashboard'))
...
WebUI.verifyElementNotPresent(findTestObject('Register Search and Advanced Options/View/h3_TestView1'), 3)
