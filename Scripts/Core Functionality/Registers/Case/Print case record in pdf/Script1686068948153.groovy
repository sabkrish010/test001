...
WebUI.callTestCase(findTestCase('Core Functionality/Registers/Case/Select Add Case (Standard Mode)'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('General/Check Print as PDF check-box'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('General/Verify last entry in report history has been generated as PDF'), [:], FailureHandling.STOP_ON_FAILURE)
