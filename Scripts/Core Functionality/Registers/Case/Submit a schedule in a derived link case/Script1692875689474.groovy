...
WebUI.click(findTestObject('Core Functionality/Registers/Case/Schedules/input_submit'))
...
WebUI.enhancedClick(findTestObject('Core Functionality/Registers/File/Preview Modal/button_Close(preview)'))
