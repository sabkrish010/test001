...
def decisionTitle = WebUI.getText()
...
WebUI.verifyTextPresent(decisionTitle, false)
...
WebUI.callTestCase(findTestCase('Core Functionality/Registers/Decision/Add Decision - Main Attach'), [:], FailureHandling.STOP_ON_FAILURE)
