...
WebUI.callTestCase(findTestCase('Core Functionality/Registers/Person/Select Add Person (Inv. Mode)'), [:], FailureHandling.STOP_ON_FAILURE)
...
def personTitle = WebUI.getText(findTestObject('Object Repository/Core Functionality/Registers/Person/SurnameFieldValue'))
...
WebUI.verifyTextPresent(personTitle, false)
