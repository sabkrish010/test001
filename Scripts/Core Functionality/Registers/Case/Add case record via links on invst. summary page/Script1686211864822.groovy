...
WebUI.click(findTestObject('General/Links/a_Add Case'))

WebUI.callTestCase(findTestCase('Core Functionality/Registers/Case/Add case pop-up'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('General/Save the record'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Core Functionality/Registers/Case/Case Link(Record Links)'))


/*Case>Delete bug needs fixing before enabling step*/
