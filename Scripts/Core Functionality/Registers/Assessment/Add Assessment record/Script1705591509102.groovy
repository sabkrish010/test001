...
WebUI.setText(findTestObject('Core Functionality/Registers/Assessment/input_Title'), 'The Strackley residence is the oldest house on the block. The Strackley mansion was the grandest house on the block, with sprawling grounds and exquisite gardens')

WebUI.setText(findTestObject('Core Functionality/Registers/Assessment/textarea_Assessment Notes'), 'Nellie was so frightened when she saw the strackley monstrous creature lurking in the shadows.')
