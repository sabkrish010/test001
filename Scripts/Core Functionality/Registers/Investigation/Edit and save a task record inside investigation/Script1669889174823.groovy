...
WebUI.click(findTestObject('Core Functionality/Registers/Task/a_Add Task(Investigation)'))

WebUI.delay(3)

WebUI.click(findTestObject('Core Functionality/Registers/Incident/Add Source link to incident/a_Create New Record'))

WebUI.callTestCase(findTestCase('Core Functionality/Tools/Task/Add Task'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Core Functionality/Registers/Task/Edit Task Record/input_edit'))

WebUI.setText(findTestObject('Core Functionality/Registers/Task/Edit Task Record/textarea_Notes'), 'The wicked correspondence scandalizes an opposed biscuit')

WebUI.click(findTestObject('Core Functionality/Registers/Task/Edit Task Record/input_save'))
