...
WebUI.setText(findTestObject('Core Functionality/Registers/Investigation/Add Investigation/input_Title'), 'Investigation of Arnold Clarkton')

WebUI.setText(findTestObject('Core Functionality/Registers/Investigation/Add Investigation/input_Reference'), 'Tax Fraud', 
    FailureHandling.OPTIONAL)

WebUI.setText(findTestObject('Core Functionality/Registers/Investigation/Add Investigation/textarea_Summary'), 'Arnold Clarkton did not pay more than £12 million of his personal expenses.')
