...
WebUI.selectOptionByValue(findTestObject('Core Functionality/Registers/Notes/Logic(New View)'), 'And', false)

WebUI.selectOptionByValue(findTestObject('Core Functionality/Registers/Notes/Filter2(New View)'), 'Details', false)

WebUI.selectOptionByLabel(findTestObject('Core Functionality/Registers/Notes/Contains2(New View)'), 'Is not empty', false)
