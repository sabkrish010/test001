...
WebUI.setText(findTestObject('Core Functionality/Registers/Address/Add Address/input_AddressLine1'), '21')

WebUI.setText(findTestObject('Core Functionality/Registers/Address/Add Address/input_AddressLine2'), 'Strackley Hill')

WebUI.setText(findTestObject('Core Functionality/Registers/Address/Add Address/input_AddressLine3'), 'Ketley Bank')

WebUI.setText(findTestObject('Core Functionality/Registers/Address/Add Address/input_AddressLine4'), 'London')
...
WebUI.setText(findTestObject('Core Functionality/Registers/Address/Add Address/input_Postcode'), 'TF2 0BJ')
