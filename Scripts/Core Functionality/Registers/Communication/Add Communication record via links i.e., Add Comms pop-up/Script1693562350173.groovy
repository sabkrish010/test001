...
WebUI.callTestCase(findTestCase('Core Functionality/Registers/Communication/Add communication via pop-up'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Core Functionality/Registers/Communication/CommsRecord UrnHyperlink(recordLinks)'))
