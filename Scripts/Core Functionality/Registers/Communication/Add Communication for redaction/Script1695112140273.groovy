...
WebUI.callTestCase(findTestCase('Core Functionality/Registers/Communication/Select Add Communication (Standard Mode)'), 
...
WebUI.setText(findTestObject('Core Functionality/Registers/Communication/Add Communication/input_Reference'), 'Monstrous')
...
WebUI.setText(findTestObject('Core Functionality/Registers/Communication/Add Communication/input_NumberOrAddress'), 'Strackley@yahoo.com')
...
WebUI.setText(findTestObject('Core Functionality/Registers/Communication/Add Communication/input_Reason'), 'Rogers')

WebUI.setText(findTestObject('Core Functionality/Registers/Communication/Add Communication/input_Source'), 'Internal by Rogers')

WebUI.setText(findTestObject('Core Functionality/Registers/Communication/Add Communication/textarea_Notes'), 'Notes')
