...
WebUI.click(findTestObject('Core Functionality/Registers/File/a_Preview Button'))

WebUI.click(findTestObject('Object Repository/Core Functionality/Registers/File/Preview Modal/span_File Preview'))

WebUI.verifyElementClickable(findTestObject('Core Functionality/Registers/File/Preview Modal/button__next'))

WebUI.click(findTestObject('Core Functionality/Registers/File/Preview Modal/button__next'))

WebUI.click(findTestObject('Core Functionality/Registers/File/Preview Modal/a_Properties'))

WebUI.verifyElementClickable(findTestObject('Core Functionality/Registers/File/Preview Modal/button__previous'))
