...
WebUI.selectOptionByLabel(findTestObject('Core Functionality/Registers/Investigation/Investigation Dropdown'), 'Operation Gooseberg', 
...
WebUI.callTestCase(findTestCase('Core Functionality/Registers/Case/Click Preview'), [:], FailureHandling.STOP_ON_FAILURE)
