...
WebUI.selectOptionByValue(findTestObject('Core Functionality/Registers/Investigation/Investigation Dropdown'), 'Operation Gooseberg', 
...
WebUI.callTestCase(findTestCase('Core Functionality/Registers/Case/Click Submit'), [:], FailureHandling.STOP_ON_FAILURE)
