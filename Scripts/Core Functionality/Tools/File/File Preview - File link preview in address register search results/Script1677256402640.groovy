...
WebUI.verifyElementPresent(findTestObject('Core Functionality/Registers/File/Preview Modal/a_Details'), 5)
...
WebUI.enhancedClick(findTestObject('General/URN SearchResults'))
