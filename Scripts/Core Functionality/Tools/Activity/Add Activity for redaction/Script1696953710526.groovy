...
WebUI.click(findTestObject('Core Functionality/Registers/Activity/a_Add Activity'))
...
WebUI.selectOptionByIndex(findTestObject('Core Functionality/Registers/Task/Add New Task record/select_Type1'), 1, FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Core Functionality/Registers/Task/Edit Task Record/input_Title(Task)'), 'Strackley Stewart doesn\'t get a culinary streak from Martha Stewart.')
