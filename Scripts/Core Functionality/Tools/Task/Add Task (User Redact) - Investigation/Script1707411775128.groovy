...
WebUI.verifyElementPresent(findTestObject('Redaction/h4_Investigation'), 0)

WebUI.click(findTestObject('Redaction/button_Redact - 1'))

WebUI.click(findTestObject('Redaction/button_Redact_Confirm - 1'))
